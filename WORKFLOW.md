...
`plan.md` est le pont de continuite entre sessions. Il contient le contexte minimal pour qu'une nouvelle session puisse poursuivre le chantier sans reconstitution.
...
Copilot doit viser uniquement l'utilite de continuite inter-sessions selon la demande explicite de l'utilisateur, y compris si cela prend la forme de notes brutes, d'une seule phrase, d'un bloc unique, ou d'une structure ad hoc.
