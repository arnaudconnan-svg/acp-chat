...
!(function (e, r) {
  ...
  var y = {
    ...
    S = function (e, r, t) {
      ...
      for (
        s = 0;
        o < t && 32 !== (n = e.charCodeAt(o)) && !(n < 32 || 127 === n);
      )
        if (92 === n && o + 1 < t) {
    ...
    F = function (e, r, t) {
      ...
      for (i++, 40 === s && (s = 41); i < t; ) {
        ...
        (10 === n
          ? o++
          : 92 === n && i + 1 < t && (i++, 10 === e.charCodeAt(i) && o++),
          i++);
      }
      return a;
    },
      ...
      [
        ...
        function (e, r, t, n) {
          ...
          for (
            ...
            (10 === s || (92 === s && ++y < C && 10 === g.charCodeAt(y))) &&
              v++;
          }
      ...
      [
        ...
        function (e) {
          var r,
            t = e.tokens_meta,
            n = e.tokens_meta.length;
          for (rr(e.delimiters), r = 0; r < n; r++)
            t[r] && t[r].delimiters && rr(t[r].delimiters);
        }
      ],
    ...
    ((e.__compiled__ = {}),
      Object.keys(e.__schemas__).forEach(function (r) {
        ...
        if (null !== t) {
          ...
          if (((e.__compiled__[r] = n), '[object Object]' === fr(t)))
            return (
              !(function (e) {
  ...
  function Jr(e) {
    var r,
      ...
      m = zr,
      g = Lr;
    for ((t = e.lastIndexOf(Tr)) < 0 && (t = 0), n = 0; n < t; ++n)
      (e.charCodeAt(n) >= 128 && jr('not-basic'), h.push(e.charCodeAt(n)));
    for (s = t > 0 ? t + 1 : 0; s < f; ) {
      for (
        o = d, i = 1, a = Dr;
  ...
  function Wr(e) {
    var r,
      ...
      m,
      g = [];
    for (h = (e = Zr(e)).length, r = zr, t = 0, o = Lr, i = 0; i < h; ++i)
      (p = e[i]) < 128 && g.push(Pr(p));
