...
const envSchema = z
  .object({
    ...
    CRITIC_OBSERVABILITY_DEBUG: booleanFromEnv(false),
    LOG_LEVEL: z
...
function inspectConfig(env = process.env) {
  ...
  const config = {
    ...
    criticObservabilityDebug: result.data.CRITIC_OBSERVABILITY_DEBUG,
...
function summarizeConfig(config) {
  ...
  return {
    ...
    criticObservabilityDebug: safeConfig.criticObservabilityDebug,
