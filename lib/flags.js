...
function normalizeConversationState(state) {
  ...
  // Legacy retired state
  if (state === "post_contact") return "exploration_open";
...
function normalizeSessionFlags(flags) {
  ...
  return {
    ...
    affiliationWindow: normalizeAffiliationWindow(safe.affiliationWindow ?? safe.contactScoreWindow),
