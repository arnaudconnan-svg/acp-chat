...
function normalizeConversationStateKey(conversationStateKey) {
  ...
  if (conversationStateKey === "discharge") return "discharge";
  // "post_contact" was removed from the state machine; legacy value maps to "exploration".
  if (conversationStateKey === "post_contact") return "exploration";
