...
function buildResponseDebugMeta({
  ...
  memoryState = null,
  memoryUpdateDecision = "hold",
  memoryUpdateReason = "unspecified",
  memoryUpdateSource = "deterministic",
  ...
  return {
    ...
    memoryPrioritySignal: typeof memoryPrioritySignal === "string" && memoryPrioritySignal ? memoryPrioritySignal : "normal",
    memoryState: normalizeMemoryState(memoryState),
    memoryUpdateDecision: memoryUpdateDecision === "update" ? "update" : "hold",
    memoryUpdateReason: typeof memoryUpdateReason === "string" && memoryUpdateReason ? memoryUpdateReason : "unspecified",
    memoryUpdateSource: typeof memoryUpdateSource === "string" && memoryUpdateSource ? memoryUpdateSource : "deterministic",
    ...
    criticDeterministicEvidence: Array.isArray(criticDeterministicEvidence) ? criticDeterministicEvidence.filter(i => typeof i === "string") : [],
    ...
    tieBreakReason: typeof tieBreakReason === "string" ? tieBreakReason : null,
    // Lot 8 fields
