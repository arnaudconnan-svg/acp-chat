...
function buildTopChips({
  ...
  if (suicideLevel === "N2") {
    ...
    chips.push(
      ...
      conversationState === "info_features" ? (Array.isArray(infoContextFlags) && infoContextFlags.includes("bot_nature_question") ? "INFO APP : nature du bot" : "INFO APP : fonctionnalités") :
