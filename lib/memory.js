...
function createMemoryHelpers({
  ...
  async function updateMemory(previousMemory, history, promptRegistry = buildDefaultPromptRegistry(), memoryPrioritySignal = "normal", theoreticalOrientationSignal = "none", intersessionMemoryCompressed = "") {
