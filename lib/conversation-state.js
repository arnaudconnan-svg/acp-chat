...
const STATE_TRANSITIONS = {
  exploration:     ["contact", "post_contact", "info", "stabilization", "alliance_rupture", "closure"],
  post_contact:    ["exploration", "contact", "info", "stabilization", "alliance_rupture", "closure"],
  contact:         ["post_contact", "exploration", "info", "stabilization", "alliance_rupture", "closure"],
  info:            ["exploration", "contact", "info", "stabilization", "alliance_rupture", "closure"],
  stabilization:   ["exploration", "contact", "info", "alliance_rupture", "closure"],
  alliance_rupture:["exploration", "contact", "info", "stabilization", "closure"],
...
// Not enforced at runtime (stored Firebase states may predate the graph),
// but used in diagnostics and future harness assertions.
