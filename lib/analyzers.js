...
`;
    ...
    try {
      ...
      const allianceSignal = ["good", "fragile", "rupture"].includes(parsed.allianceSignal)
        ? parsed.allianceSignal : "good";
      ...
      return { allianceSignal, engagementLevel, processingWindow };
    } catch {
      return { allianceSignal: "good", engagementLevel: "active", processingWindow: "open" };
    }
  }
