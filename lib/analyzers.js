...
`;
  ...
  async function analyzeSuicideRisk(
    ...
    try {
      ...
      // Lock N1 behind explicit personal suicide markers in the user message.
      // This avoids ambiguous existential-emptiness turns being routed as N1.
      if (suicideLevel === 'N1' && !hasExplicitPersonalSuicideMarker(message)) {
        suicideLevel = 'N0';
      }
