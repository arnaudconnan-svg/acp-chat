...
`;
  ...
  function imminentMajorHarmFallback() {
    return "Je ne peux pas t'aider a preparer ou commettre une action qui met des personnes en danger. Cela peut avoir de lourdes consequences penales et humaines, pour toi comme pour les personnes visees. Qu'est-ce qui se passe en toi juste avant cette montee vers le passage a l'acte ?";
  }
  ...
  async function imminentMajorHarmResponseLLM(
    ...
    if (!out || out.length > 520) return imminentMajorHarmFallback();
    return out;
  }
