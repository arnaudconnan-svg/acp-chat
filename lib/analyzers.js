...
`;
    ...
    try {
      ...
      const parsed = JSON.parse(raw);
      if (!parsed.isContact) {
        return { isContact: false, contactSignal: null, selfCriticismLevel: "low", insightMoment: false };
      }
      ...
      return { isContact: true, contactSignal, selfCriticismLevel, insightMoment };
    } catch {
      return { isContact: false, contactSignal: null, selfCriticismLevel: "low", insightMoment: false };
    }
  }
