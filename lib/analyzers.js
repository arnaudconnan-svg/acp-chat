...
`;
    ...
    try {
      ...
      if (!parsed.isContact) {
        return { isContact: false, detectedState: null };
      }
      // Map LLM contactSubmode to detectedState
      const submode = parsed.contactSubmode === "dysregulated" ? "dysregulated" : "regulated";
      return {
        isContact: true,
