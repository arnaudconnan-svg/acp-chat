...
function buildPostureDecision({
  ...
  // E4 + E5 — signal overrides before state resolution
  ...
  if (!contactEstablished && detectedState === "exploration") {
    signalForStateResolution = "contact";
  }
  ...
  const { maxSentences = null, toneConstraint = null } = STATE_CONSTRAINTS[effectiveConversationState] || {};
