...
function buildPostureDecision({
  ...
  const phraseLengthPolicy = responseRegister === "familier"
    ? "courte"
    : (["stabilization", "alliance_rupture", "need_human_support", "closure", "discharge_dysregulated"].includes(effectiveConversationState) ? "courte" : "moyenne");
