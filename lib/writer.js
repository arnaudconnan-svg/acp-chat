...
[[${marker}_END]]`;
  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    const INTENT_HINT_TEXTS = {
      ...
      hold_emotional_thread: "Hint fil emotionnel : Quelque chose commencait a emerger et s'est coupe. Ne laisse pas cette piste disparaitre silencieusement. Reconnais doucement ce qui etait la avant la coupure, sans forcer a y retourner.",
  ...
  function buildPostContactLandingPromptBlock(conversationStateKey, promptRegistry = buildDefaultPromptRegistry()) {
    if (conversationStateKey !== "contact") return "";
