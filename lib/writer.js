...
[[${marker}_END]]`;
  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    const INTENT_HINT_TEXTS = {
      ...
      attention_engagement_soft_guidance: "Si tu sens une baisse de l'attention ou de l'engagement de l'utilisateur, essaye de simplifier et de revenir a l'essentiel.",
