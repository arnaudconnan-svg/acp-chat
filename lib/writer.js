...
[[${marker}_END]]`;
  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    if (phraseLengthPolicy === 'courte') {
      lines.push(
        'Execution longueur : privilegie des phrases courtes et directes; coupe les longues constructions.'
      );
    } else {
      lines.push(
        'Execution longueur : garde des phrases de taille moyenne; evite les phrases longues en cascade.'
      );
    }
    ...
    if (
      postureDecision.secondaryTension &&
      typeof postureDecision.secondaryTension === 'object'
    ) {
      ...
      const familyLabel =
        st.family === 'discharge'
          ...
          : st.family === 'info'
            ? 'questionnement factuel'
            : st.family === 'alliance_rupture'
              ? "rupture d'alliance"
      ...
      const step3Map = {
        discharge:
          'Formule le message li\u00e9 \u00e0 la d\u00e9charge : une reconnaissance sobre de la charge perceptible derri\u00e8re le message principal, sans inciter \u00e0 la lib\u00e9rer ni amplifier.',
        ...
        exploration:
          'Formule le message li\u00e9 au mouvement exploratoire : une invitation douce \u00e0 regarder ce qui cherche \u00e0 se comprendre l\u00e0-dedans \u2014 une seule phrase sobre, sans ouvrir de nouveau chantier.',
        alliance_rupture:
          "Formule le message lie a la rupture d'alliance : une validation sobre du decalage percu, sans justification ni excuse elaboree."
      };
