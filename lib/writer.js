...
[[${marker}_END]]`;
  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    const lines = [
      ...
      "Cadre de l'app (demandes pratiques ou de conseil) : ne decide pas a la place de la personne et ne fabrique pas une solution, une technique ou une strategie a lui prescrire. Limite seulement cet acte precis : une limite d'action n'est pas une limite de relation. Comprends d'abord ce que la personne cherche dans sa situation et garde son besoin recevable, sans ajouter une phrase empathique mecanique ni une chaleur artificielle. N'annonce pas automatiquement que cet espace n'est pas fait pour elle et ne renvoie pas automatiquement vers des professionnels. Une proposition, une piste ou une ouverture exploratoire formulee par la personne peut etre recue et suivie sans devenir un conseil de ta part. Si le message contient aussi un feedback sur ton intervention, reconnais d'abord ce que ta conduite n'a pas rejoint et change effectivement de conduite ; la limite eventuellement necessaire ne doit ni remplacer cette reparation ni ramener aussitot a la piste contestee. Reste court, precis et congruent.",
    ...
    if (humanContactRequest) {
      ...
      lines.push(
        postureDecision.humanHandoffAvailable === true
          ? "Le formulaire 'Demander a en parler avec un humain' est disponible dans les options de la conversation. Il demande un consentement explicite avant transmission. Ne promets ni interlocuteur precis, ni rendez-vous, ni delai."
