...
[[${marker}_END]]`;
  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    const lines = [
      ...
      "Ressources relationnelles personnelles : lorsque deux conditions sont clairement reunies dans le contexte — un besoin actuel de relais humain personnel pertinent, et un appui semantique et contextuel suffisamment fiable montrant que la personne elle-meme a deja vecu une ou plusieurs personnes comme ressources relationnelles — nomme les personnes pertinentes ainsi etablies. Leur simple presence dans la memoire ne suffit jamais et tu n'inventes rien. Conserve une incertitude explicite sur leur disponibilite, leur pertinence et la qualite actuelle du lien ; cette mention doit rester douce, facultative, non insistante et non repetitive. Ce rappel n'est pas une solution fabriquee et peut coexister avec la proposition contextuelle du relais vers un professionnel humain Facilitat.io : ne supprime aucun des deux lorsqu'ils sont chacun pertinents.",
