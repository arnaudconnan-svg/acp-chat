...
[[${marker}_END]]`;
  ...
  function buildSystemPrompt(postureDecision, memory, promptRegistry = buildDefaultPromptRegistry(), infoSubmode = null, interpretationRejection = null, contactSubmode = null) {
    ...
    if (writerMode === "n1_crisis") {
      ...
      // Contact et closure : contrat uniquement (pas de bloc de style).
      // Stabilization et alliance_rupture : blocs de style dédiés injectés.
      styleBlock = buildStabilizationPromptBlock(writerMode, promptRegistry)
