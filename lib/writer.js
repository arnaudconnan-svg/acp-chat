...
[[${marker}_END]]`;
  ...
  function getInfoPrompt(infoSubmode = null, promptRegistry = buildDefaultPromptRegistry()) {
    ...
    return wrapPromptBlock("MODE_INFORMATION", infoBlockContent);
  }
  ...
  function buildSystemPrompt(postureDecision, memory, promptRegistry = buildDefaultPromptRegistry(), infoSubmode = null, interpretationRejection = null, contactSubmode = null) {
    ...
    if (writerMode === "n1_crisis") {
      ...
      styleBlock = getInfoPrompt(infoSubmode, promptRegistry);
