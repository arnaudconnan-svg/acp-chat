  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    if (
      ...
      const forbiddenDefs = {
        ...
        casual_register:
          'adresse vivante ou complice installee lors des tours precedents : revenir ce tour a une adresse neutre et contenue, sans chaleur acquise, sans ponctuation expressive, sans proximite tonale'
      };
