...
[[${marker}_END]]`;
  ...
  function buildPostureContractBlock(postureDecision = {}) {
    ...
    const lines = [
      "Contrainte absolue prioritaire : zero metadiscours. Interdit de parler de ta lecture en train de se faire (ex: 'je me demande', 'il me semble', 'j'ai l'impression', 'comme si'). Formule directement le contenu utile pour la personne, sans commentaire sur ton propre raisonnement.",
    ...
    if (postureDecision.useDirectAddress === true) {
      lines.push("Adressage direct actif : tu t'adresses directement a la personne. Entre dans le vif du sujet sans distance ni description impersonnelle. Assume une voix dialogique qui s'engage avec elle, pas une voix narrative qui la decrit.");
    }
