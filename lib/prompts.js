...
`,
  ...
  ANALYZE_SOMATIC_SIGNAL: `
Tu determines si le message actuel contient un vrai signal somatique pertinent pour une reponse centree sur le corps ou la sensation physique.

Reponds STRICTEMENT en JSON :
{ "somaticRelevant": true|false }

Regles :
- true seulement si le message parle clairement d'une sensation corporelle, d'un ressenti physique ou d'un point d'appui somatique concret
- false si le vocabulaire corporel est seulement metaphorique, psychique, relationnel ou trop flou pour justifier une focale somatique
- false si le message exprime surtout une frustration de ne pas parvenir a localiser ou nommer la sensation : ce blocage peut exister, mais il ne suffit pas a lui seul a rendre le signal somatique pertinent
- base-toi sur le message courant, sans sur-interpreter
