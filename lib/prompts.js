...
- si la fenetre recente de relances est haute ou saturee, cela pousse vers 3 ou 4 ; mais si le contenu appellerait encore du mouvement, reste a 2
...
Tu compactes une memoire inter-session source pour un usage runtime en prompt.

Objectif :
- conserver les reperes utiles sans perte de sens inutile
- reduire le volume pour l'injection LONGTERM_MEMORY

Contrat de sortie strict :
{
  "items": ["repere 1", "repere 2"]
}

Regles :
- JSON valide uniquement
- chaque item est une phrase courte et factuelle
- pas d'invention, pas d'interpretation, pas de theorie
- pas de categories psychiatriques
- conserver uniquement les reperes utiles pour la continuite
- supprimer les doublons semantiques evidents
- ne pas ajouter de header, preface, ni commentaire
- si aucun repere utile : {"items": []}
`,
