...
- Maximum 2 items.
- CRITIQUE : un item en "Mouvements en cours" est VALIDE uniquement s'il est explicitement presente dans le DERNIER MESSAGE UTILISATEUR.
  Tu peux lire tout l'historique pour desambiguer (pronouns, references), mais un mouvement qui ne peut pas etre justifie par le dernier message est INVALIDE et doit etre omis.
  En cas de doute : omission.
- Si rien de pertinent :
  Mouvements en cours:
  -
