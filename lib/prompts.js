...
`,
    ...
    // ------------------------------------
    // PROMPT COMMUN A TOUS LES ETATS
    // ------------------------------------
...
Tu determines si le message utilisateur et le contexte actuel necessitent l'etat "relational_adjustment" plutot que exploration ou contact.
...
`,
    ...
    // ------------------------------------
    // GESTION DES ETATS CONTACT ET DECHARGE
    // ------------------------------------
...
Si isContact = false, contactSubmode doit etre null et aggressiveDischargeDirectedToBot doit etre false.
...
Cet etat est distinct de la decharge (pleurs, rage, effondrement) : il n'y a pas de debordement manifeste, mais une charge emotionnelle interne presente et dirigee contre soi.
...
contactSubmode : "meaning_making" si meaningCrisis = true, "insight" si insightMoment = true, sinon "regulated"
...
`,
    ...
    STATE_DISCHARGE_CONTACT: `
Etat CONTACT (decharge).
...
- le "je" est autorisé uniquement pour ancrer ta perception (ex : "je perçois", "j'entends", "je sens que")
- interdit : exprimer un ressenti personnel du bot (ex : "ça me touche", "je suis touché", "ça me fait quelque chose")
- puis tu t'arretes
