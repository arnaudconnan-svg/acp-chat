...
Les deux blocs doivent toujours être présents, même s'ils sont vides (mettre "-").
Le bloc "Anciens mouvements" est géré automatiquement par le système — ne l'écris pas.
3. CONTEXTE STABLE
...
- \`periodic_refresh\` : refresh periodique. Recalcule "Mouvements en cours" from scratch depuis l'echange recent (sans conserver par inertie les anciens items). Le transfert vers "Anciens mouvements" est géré automatiquement — ne pas l'écrire.
