...
5. AGENTIVITE_ATTRIBUEE : le texte attribue a la personne une intention, un choix, une strategie ou une volonte non explicitement revendiques ("tu as choisi", "tu veux", "tu t'en sers", "tu fais ca pour ..."). Reformule en phenomenologie observable (mouvement, variation, tension) ou en attribution explicite a sa parole ("tu dis que...").
...
issues contient uniquement les violations corrigees, par nom court (ex: "violation_theorique", "clinicalisation_excessive", "presence_creuse", "agency_attribution", "forbidden_relance", etc.). Si aucune : tableau vide.
`,
