...
`,
  ...
  // LEGACY – orphan, non référencé par le writer (doublon sémantique de STATE_INFO_FEATURES / STATE_INFO_PSYCHOEDUCATION)
...
`,
  ...
  // LEGACY – orphan, non référencé par le writer
