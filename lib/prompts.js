...
Reponds STRICTEMENT en JSON :
{
  ...
  "dischargeSubmode": "regulated|dysregulated|null",
...
- exception explicite : si le message decrit une montee anxieuse tres rapide avec sensation de perte de controle et urgence d'arreter immediatement, classe isDischarge = true avec dischargeSubmode = dysregulated
- quand isDischarge = true, choisis un sous-mode :
...
Si isDischarge = false, dischargeSubmode doit etre null et aggressiveDischargeDirectedToBot doit etre false.
...
Si previousContactState.wasContact = true, sois un peu plus sensible a la possibilite qu'une decharge soit encore presente, sans la forcer.
