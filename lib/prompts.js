...
- limiting_belief : une croyance-frein est explicitement ou quasi-explicitement présente, posant un plafond de possibilité — impossibilité ("je ne pourrai jamais"), fatalité ("c'est comme ça, ça changera pas"), disqualification de soi ("je ne suis pas faite pour ça", "je suis nulle dans ces situations"), ou obligation rigide absolutisante ("il faut que je sois parfaite sinon"). Faux positifs à exclure : surcharge situationnelle, fatigue, hésitation, difficulté contextuelle passagère, évaluation réaliste d'une contrainte sans absolutisation (ex : "c'est peut-être pas à moi de gérer ça")
...
- ne mobilise pas cette orientation si l'etat n'est pas "exploration" (en etat contact ou info, ce signal n'est pas utilise)
...
Tu analyses la qualite de la relation et de la disponibilite de la personne dans cet echange.
...
- "Mouvements en cours" de la session fermée
