...
{
  "theoreticalOrientation": "disconnection|limiting_belief|discharge_in_progress|transformation_in_progress|adaptive_mechanism|relational_need|limit_expression|unfinished_business|none",
...
- discharge_in_progress : une décharge émotionnelle est en cours ou vient de se produire — pleurs, montée soudaine, lâcher, débordement, soulagement brusque, colère qui sort ; distinct du contact (isContact gère le contact aigu, orientationConfidence ici concerne le mouvement post-lâcher ou la décharge encore active mais non aiguë)
...
- unfinished_business : la personne exprime un affect actif non résolu envers une personne significative du passé (parent, ex-partenaire, ami perdu, figure d'autorité) — il y a quelque chose qui n'a pas pu être dit, vécu ou accompli avec cette personne, et cet inachevé est encore actif maintenant
...
- "la ca a lache d'un coup, je pleure sans vraiment savoir pourquoi" -> discharge_in_progress, confiance haute
...
- discharge_in_progress : décharge émotionnelle en cours ou récente
