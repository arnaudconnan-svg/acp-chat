...
try {
  ...
  const facilitatLogs = allLines.filter(
    (line) => line.includes('Facilitat') || line.includes('facilitat')
  );
  ...
  console.error(
    'Error reading logcat. Make sure adb is available and device is connected.'
  );
  process.exit(1);
}
